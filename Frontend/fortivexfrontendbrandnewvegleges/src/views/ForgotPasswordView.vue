  ...
  <div class="info-page">
    <div class="info-bg">
      <div class="info-card">
        ...
        <h1 class="page-title">Jelszó helyreállítás</h1>
        <div class="divider"></div>

        <div class="content">
          <div class="section">
            <div v-if="!emailSent">
              <p>Add meg az email címed és küldünk egy helyreállítási linket.</p>
              <form @submit.prevent="handleSubmit" class="auth-form">
                <div class="form-group">
                  <label>Email cím</label>
                  <input v-model="email" type="email" placeholder="pelda@email.com" required />
                </div>
                <div v-if="error" class="error-message">{{ error }}</div>
                <button type="submit" class="submit-button" :disabled="loading">
                  {{ loading ? "Küldés..." : "Helyreállítási link küldése" }}
                </button>
              </form>
            </div>
            ...
            <div v-else class="success-box">
              ...
              <p>
                Elküldtük a helyreállítási linket a <strong>{{ email }}</strong> címre.
              </p>
...
const handleSubmit = async () => {
  ...
  if (success) {
    ...
    error.value = authStore.error || "Hiba történt. Próbáld újra!";
  }
