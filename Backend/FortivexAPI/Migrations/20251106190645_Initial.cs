    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 10, 27, 20, 6, 44, 567, DateTimeKind.Local).AddTicks(93), "test@fortivex.com", new DateTime(2025, 11, 6, 20, 6, 44, 567, DateTimeKind.Local).AddTicks(97), "test123", "testplayer" },
                    { 2, new DateTime(2025, 10, 17, 20, 6, 44, 567, DateTimeKind.Local).AddTicks(104), "admin@fortivex.com", new DateTime(2025, 11, 6, 20, 6, 44, 567, DateTimeKind.Local).AddTicks(106), "admin123", "adminuser" },
                    { 3, new DateTime(2025, 11, 1, 20, 6, 44, 567, DateTimeKind.Local).AddTicks(111), "player2@fortivex.com", new DateTime(2025, 11, 6, 20, 6, 44, 567, DateTimeKind.Local).AddTicks(113), "pass123", "player2" }
                });

            migrationBuilder.InsertData(
                table: "Admins",
                columns: new[] { "Id", "AccountId", "AssignedAt", "Role" },
                values: new object[] { 1, 2, new DateTime(2025, 10, 22, 20, 6, 44, 567, DateTimeKind.Local).AddTicks(497), "Admin" });
